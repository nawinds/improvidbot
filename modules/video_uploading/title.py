...
@bot.message_handler(func=lambda message: get_state(message) == NEW_VIDEO_TITLE_STATE)
def new_video_title(message):
    title = message.text
    if title and len(title) <= 100:
        ...
        for tag in tags:
            ...
            if tag_db:
                ...
                session.commit()
        bot.send_message(message.from_user.id, "Придумайте <b>описание</b>\n\n"
        ...
        bot.send_message(message.from_user.id, "Слишком длинное название (более 100 символов). "
        ...
        bot.send_message(message.from_user.id, "Вы ничего не написали. Пожалуйста, выберите, "
                                               "как назвать видео\n\n"
                                               "<i><a href=\"https://telegra.ph/Kak-zagruzhat-video-v-bazu-bota-"
                                               "i-uvelichivat-ih-prosmotry-07-03\">"
                                               "Советы по оформлению ролика</a>\n"
